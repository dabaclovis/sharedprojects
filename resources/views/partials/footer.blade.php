    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 mb-4 mb-md-0">
                <a wire:navigate class="h5 font-weight-bold d-inline-block mb-3" href="{{ route('pages.index') }}"><x-brand /></a>
            ...
            <div class="col-md-4 mb-4 mb-md-0 text-md-center">
                ...
                <nav aria-label="Footer navigation">
                    <ul class="list-unstyled mb-0">
                        <li class="mb-2"><a wire:navigate href="{{ route('pages.about') }}" @if (request()->routeIs('pages.about')) aria-current="page" @endif>About</a></li>
                        <li><a wire:navigate href="{{ route('pages.contact') }}" @if (request()->routeIs('pages.contact')) aria-current="page" @endif>Contact</a></li>
                        <li class="mt-2"><a wire:navigate href="{{ route('pages.policy') }}" aria-current="{{ request()->routeIs('pages.policy') ? 'page' : 'false' }}">Privacy &amp; policy</a></li>
                    </ul>
                </nav>
            </div>
