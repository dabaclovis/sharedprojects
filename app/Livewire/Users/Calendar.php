...
class Calendar extends Component
{
    ...
    {
        $this->reset('eventId', 'showEditor', 'title', 'description', 'location', 'timezone', 'starts_at', 'ends_at', 'status', 'color');
    ...
    public function edit(int $id): void
    {
        ...
        $this->color = array_key_exists($event->color, Event::COLORS) ? $event->color : 'blue';
    ...
    public function save(): void
    {
        ...
        $data = $this->validate([
            ...
            'color' => ['required', Rule::in(array_keys(Event::COLORS))],
        ]);
